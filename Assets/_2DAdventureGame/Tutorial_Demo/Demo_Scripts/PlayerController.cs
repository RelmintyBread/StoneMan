...
namespace Beginner2D
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        void Launch()
        {
            ...
            GameObject test;
            test = GameObject.Instantiate(projectilePrefab, rigidbody2d.position + moveDirection * 0.5f, Quaternion.identity); 
            Projectile test2 = test.GetComponent<Projectile>();
                       
            test2.Launch(moveDirection,300f);
